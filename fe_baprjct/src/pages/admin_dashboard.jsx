...
const AdminDashboard = () => {
  ...
  const UserIssuesManagement = () => (
    <div style={styles.managementContainer}>
      <div style={styles.managementHeader}>
        <h2 style={styles.managementTitle}>📊 Problèmes des utilisateurs</h2>
  ...
  const DashboardOverview = () => (
    <div style={styles.dashboardGrid}>
      ...
      <div style={styles.statCard}>
        <div style={styles.statIcon}>💰</div>
        <div style={styles.statContent}>
          <h3 style={styles.statNumber}>370K</h3>
          <p style={styles.statLabel}>Budget total (DH)</p>
          <small style={styles.statSubtext}>Tous projets confondus</small>
        </div>
      </div>
      ...
      <div style={styles.activityCard}>
        ...
        <div style={styles.activityList}>
          ...
          <div style={styles.activityItem}>
            <span style={styles.activityDot}></span>
            <div>
              <p>Nouveau message de support reçu</p>
      ...
      <div style={styles.actionsCard}>
        ...
        <div style={styles.actionButtons}>
          ...
          <button style={styles.actionButton} onClick={() => setActiveSection('reports')}>
  ...
  const UsersManagement = () => (
    <div style={styles.managementContainer}>
      <div style={styles.managementHeader}>
        <h2 style={styles.managementTitle}>👥 Gestion des utilisateurs</h2>
        <button style={styles.addButton}>+ Ajouter utilisateur</button>
      </div>
          ...
          <tbody>
            {filteredUsers.map(user => (
              <tr key={user.id} style={styles.tableRow}>
                ...
                <td style={styles.tableCell}>
                  <div style={styles.actionButtons}>
                    <button style={styles.actionButtonSmall}>✏️</button>
                    <button style={styles.actionButtonSmall}>👁️</button>
                    <button style={styles.actionButtonSmall}>🗑️</button>
                  </div>
                </td>
  ...
  const ProjectsManagement = () => (
    <div style={styles.managementContainer}>
      <div style={styles.managementHeader}>
        <h2 style={styles.managementTitle}>📋 Gestion des projets</h2>
        <button 
          style={styles.addButton}
          onClick={() => window.location.href = '/nouveau-projet'}
        >
          + Nouveau projet
        </button>
      </div>
      ...
      <nav style={styles.nav}>
        <div style={styles.navContainer}>
          <div style={styles.navBrand}>
            ...
            <span style={styles.brandText}>Admin Dashboard</span>
          </div>
          <div style={styles.navLinks}>
            <span style={styles.welcomeText}>Bienvenue, Admin</span>
      ...
      <div style={styles.mainContainer}>
        <div style={styles.contentLayout}>
          ...
          <aside style={styles.sidebar}>
            <div style={styles.sidebarCard}>
              ...
              <nav style={styles.sidebarNav}>
                ...
                <button
                  style={{
                    ...styles.sidebarButton,
                    ...(activeSection === 'reports' ? styles.sidebarButtonActive : {})
                  }}
            ...
            {/* Admin Info */}
            <div style={styles.sidebarCard}>
              <h3 style={styles.sidebarTitle}>👤 Informations Admin</h3>
              <div style={styles.adminInfo}>
                ...
                />
                <div>
                  <p style={styles.adminName}>Youssef Alami</p>
                  <p style={styles.adminRole}>Super Administrateur</p>
                  <p style={styles.adminLastLogin}>Connecté depuis 9:30</p>
                </div>
              </div>
            </div>
          </aside>
